...
<section class="bg-black dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-white dark:text-white">Designed for
                ...
                <div class="flex justify-center items-center">
                    ...
                    <span class="text-base font-medium text-gray-300 dark:text-gray-400">
                        Yearly
                    </span>
                </div>
            </div>
            <div class="grid gap-8 xl:grid-cols-3 xl:gap-10">
                <!-- Pricing Card -->
                <div class="flex flex-col p-6 mx-auto max-w-xl text-center bg-white rounded-lg border border-gradient shadow xl:max-w-lg dark:border-gray-700 dark:bg-gray-800 xl:p-8">
                    <defs>
                    ...
                    <p class="mt-4 mb-1 text-gray-500 text-light dark:text-gray-400">$19 USD per month, paid annually
                    </p>
                    <a href="#"
                    ...
                    <button type="button" style="margin-top: 10%; margin-bottom: 10%;" class="text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 shadow-lg shadow-purple-500/50 dark:shadow-lg dark:shadow-purple-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Get Started</button>
                    <!-- List -->
                ...
                <div
                    ...
                    <div class="mb-2">
                        <span
                            class="py-1 px-3 text-sm text-primary-800 bg-primary-100 rounded dark:bg-primary-200 dark:text-primary-800">Most
                            popular</span>
                    </div>
                    ...
                    <p class="mt-4 mb-1 text-gray-500 text-light dark:text-gray-400">$159 USD per month, paid annually
                    </p>
                    <a href="#"
                        class="inline-flex justify-center items-center font-medium text-primary-600 hover:text-primary-800 dark:text-primary-500 dark:hover:text-primary-700">
                        Go to annual plan
                ...
                <div
                    ...
                    <p class="mt-4 mb-1 text-gray-500 text-light dark:text-gray-400">$499 USD per month, paid annually
                    </p>
                    <a href="#"
                        class="inline-flex justify-center items-center font-medium text-primary-600 hover:text-primary-800 dark:text-primary-500 dark:hover:text-primary-700">
                        Go to annual plan
...
<style scoped>
/* Ajoutez cette classe pour le style de la bordure avec gradient */
:root {
  --color-cyan-500: #00bcd4;
  --color-purple-500: #9c27b0;
}
.border-gradient {
    border-image: linear-gradient(to right, var(--color-cyan-500), var(--color-purple-500));
    border-image-slice: 1;
    border-width: 2px; /* Ajustez l'épaisseur de la bordure selon vos besoins */
}
</style>