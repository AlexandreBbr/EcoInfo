            ...
            <div class="relative">
                <div class="lg:w-2/3">
                    ...
                    <div class="relative inline-flex items-center justify-center mt-8 sm:mt-12 group">
                        ...
                        <a href="#" title="" class="relative inline-flex items-center justify-center px-8 py-3 text-base font-normal text-white bg-black border border-transparent rounded-full" role="button"> Free 30 days Trial </a>
                    </div>

                    <div>
                        <div class="inline-flex items-center pt-6 mt-8 border-t border-black sm:pt-10 sm:mt-14">
                ...
                <div class="mt-8 md:absolute md:mt-0 md:top-32 lg:top-0 md:right-0">
                    <img class="animate-jump animate-infinite animate-duration-[18000ms] animate-delay-[1ms] w-full max-w-xs mx-auto lg:max-w-lg xl:max-w-xl" src="https://landingfoliocom.imgix.net/store/collection/dusk/images/hero/1/3d-illustration.png" alt="" />
                </div>
            </div>
        </div>
    </section>
