        ...
        <div class="py-8 px-4 mx-auto space-y-12 max-w-screen-xl lg:space-y-20 sm:py-16 lg:px-6">
            ...
            <div class="gap-8 items-center lg:grid lg:grid-cols-2 xl:gap-16">
                <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                    <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-white dark:text-white">Work with
                    ...
                    <ul role="list" class="pt-8 my-7 space-y-5 border-t border-gray-200 dark:border-gray-700">
                        <li class="flex space-x-3">
                            ...
                            <span class="text-base font-medium leading-tight  dark:text-white">Continuous
                        ...
                        <li class="flex space-x-3">
                            ...
                            <span class="text-base font-medium leading-tight  dark:text-white">Development
                                workflow</span>
                        </li>
                        <li class="flex space-x-3">
                            <!-- Icon -->
                            ...
                            <span class="text-base font-medium leading-tight  dark:text-white">Knowledge
                                management</span>
                        </li>
                    </ul>
                    <p class="mb-8 font-light lg:text-xl">Deliver great service experiences fast - without the
            ...
            <div class="gap-8 items-center lg:grid lg:grid-cols-2 xl:gap-16">
                ...
                <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                    <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-white dark:text-white">We invest in
                    ...
                    <ul role="list" class="pt-8 my-7 space-y-5 border-t border-gray-200 dark:border-gray-700">
                        <li class="flex space-x-3">
                            ...
                            <span class="text-base font-medium leading-tight  dark:text-white">Dynamic
                        ...
                        <li class="flex space-x-3">
                            ...
                            <span class="text-base font-medium leading-tight  dark:text-white">Templates
                                for everyone</span>
                        </li>
                        <li class="flex space-x-3">
                            <!-- Icon -->
                        ...
                        <li class="flex space-x-3">
                            ...
                            <span class="text-base font-medium leading-tight  dark:text-white">Limitless
